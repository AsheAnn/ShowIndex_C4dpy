...
def displayPntIndex(obj):
    ...
    Null[c4d.ID_BASELIST_ICON_FILE] = '5140'
    Null[c4d.ID_BASELIST_ICON_COLORIZE_MODE] = 2
    Null[c4d.ID_BASELIST_ICON_COLOR] = c4d.Vector(1, 0.986, 0.15)
    ...
    Cloner[c4d.ID_BASELIST_ICON_FILE] = '12530'
...
def displayEdgeIndex(obj):
    ...
    Null[c4d.ID_BASELIST_ICON_FILE] = '5140'
    Null[c4d.ID_BASELIST_ICON_COLORIZE_MODE] = 2
    Null[c4d.ID_BASELIST_ICON_COLOR] = c4d.Vector(0, 1, 0)
    ...
    Cloner[c4d.ID_BASELIST_ICON_FILE] = '16351'
...
def displayPrimIndex(obj):
    ...
    Null[c4d.ID_BASELIST_ICON_FILE] = '5140'
    Null[c4d.ID_BASELIST_ICON_COLORIZE_MODE] = 2
    Null[c4d.ID_BASELIST_ICON_COLOR] = c4d.Vector(1, 0, 0)
    ...
    Cloner[c4d.ID_BASELIST_ICON_FILE] = '12532'
